...
export default function CategoryPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F2F0EF] pt-28 px-6 pb-16">
      ...
      <button
        onClick={() => navigate(-1)}
        className="flex items-center gap-2 mb-8 text-black/70 hover:text-black transition"
      >
        <ArrowLeft size={18} />
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12">
        ...
        {/* LEFT FORM */}
        <div className="bg-white rounded-3xl shadow-xl border border-black/10 p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={saving}
              className="w-full bg-black text-white py-4 rounded-2xl hover:opacity-90 transition font-medium tracking-wide"
            >
            ...
            <div className="space-y-5">
              ...
              {categories.map((cat) => (
                ...
                >
                  ...
                  <p className="text-sm text-black/65 mb-2 leading-relaxed">
