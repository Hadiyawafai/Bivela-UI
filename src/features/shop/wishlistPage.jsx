// =======================================================
// ✅ FIXED FINAL WISHLIST PAGE
// Handles ALL possible backend response structures
// =======================================================
              ...
              >
                ...
                <div className="relative overflow-hidden">
                  ...
                  <button
                    ...
                    className="absolute top-4 right-4 w-11 h-11 bg-white/90 backdrop-blur-sm flex items-center justify-center hover:bg-red-500 hover:text-white transition"
                  >
                    {removingId ===
                    variantId ? (
                      "..."
